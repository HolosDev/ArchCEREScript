...
showb3 n a b c =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c
showb4 :: (TextShow a, TextShow b, TextShow c, TextShow d) => Text -> a -> b -> c -> d -> Builder
showb4 n a b c d =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c <> singleton ':' <> showb d
showb5 :: (TextShow a, TextShow b, TextShow c, TextShow d, TextShow e) => Text -> a -> b -> c -> d -> e -> Builder
showb5 n a b c d e =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c <> singleton ':' <> showb d <> singleton ':' <> showb e
showb6 :: (TextShow a, TextShow b, TextShow c, TextShow d, TextShow e, TextShow f) => Text -> a -> b -> c -> d -> e -> f -> Builder
showb6 n a b c d e f =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c <> singleton ':' <> showb d <> singleton ':' <> showb e <> singleton ':' <> showb f
...
showb7 n a b c d e f g =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c <> singleton ':' <> showb d <> singleton ':' <> showb e <> singleton ':' <> showb f <> singleton ':' <> showb g
...
showb8 n a b c d e f g h =
  fromText n <> singleton '=' <> showb a <> singleton ':' <> showb b <> singleton ':' <> showb c <> singleton ':' <> showb d <> singleton ':' <> showb e <> singleton ':' <> showb f <> singleton ':' <> showb g <> singleton ':' <> showb h
...
showbCSC0 ih ic =
  showb ih <> singleton ' ' <> showb ic
showbCSC1 :: TextShow a => IHeader -> CHeader -> a -> Builder
showbCSC1 ih ic a =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a
showbCSC2 :: (TextShow a, TextShow b) => IHeader -> CHeader -> a -> b -> Builder
showbCSC2 ih ic a b =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b
showbCSC3 :: (TextShow a, TextShow b, TextShow c) => IHeader -> CHeader -> a -> b -> c -> Builder
showbCSC3 ih ic a b c =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c
showbCSC4 :: (TextShow a, TextShow b, TextShow c, TextShow d) => IHeader -> CHeader -> a -> b -> c -> d -> Builder
showbCSC4 ih ic a b c d =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c <> singleton ' ' <> showb d
...
showbCSC5 ih ic a b c d e =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c <> singleton ' ' <> showb d <> singleton ' ' <> showb e
...
showbCSC6 ih ic a b c d e f =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c <> singleton ' ' <> showb d <> singleton ' ' <> showb e <> singleton ' ' <> showb f
...
showbCSC7 ih ic a b c d e f g =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c <> singleton ' ' <> showb d <> singleton ' ' <> showb e <> singleton ' ' <> showb f <> singleton ' ' <> showb g
...
showbCSC8 ih ic a b c d e f g h =
  showb ih <> singleton ' ' <> showb ic <> singleton ' ' <> showb a <> singleton ' ' <> showb b <> singleton ' ' <> showb c <> singleton ' ' <> showb d <> singleton ' ' <> showb e <> singleton ' ' <> showb f <> singleton ' ' <> showb g <> singleton ' ' <> showb h
